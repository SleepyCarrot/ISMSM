...
function [POS_fit,POS]=IMOMPA(SearchAgents_no,Max_iter,lb,ub,dim,fobj,nobj,nInt)
...
% % 立方映射
% Positions=rand(1,dim)*2-1;
% for i=2:SearchAgents_no
%     Positions(i,:)=4*Positions(i-1,:).^3-3*Positions(i-1,:);
% end
...
% for i=2:SearchAgents_no
%     Positions(i,:)=a*Positions(i-1,:).*(1-Positions(i-1,:));
% end
